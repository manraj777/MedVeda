'use client';
import '../styles/SearchNavbar.css'; // Import your CSS file for custom styles
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white shadow-sm">
      ...
      <div className='container mx-auto px-4 py-4'>
        ...
        <button onClick={() => router.push('/saved')} className="text-[#8B5E3C] hover:text-[#6B4423] focus:outline-none focus:ring-0 border-none">
